...
--
-- Host: localhost
-- Generation Time: Dec 12, 2024 at 03:41 PM
...
--
-- Table structure for table `wlp_comments`
--

CREATE TABLE IF NOT EXISTS `wlp_comments` (
...
--
-- Table structure for table `wlp_links`
--

CREATE TABLE IF NOT EXISTS `wlp_links` (
...
--
-- Table structure for table `wlp_object_relationshipmeta`
--

CREATE TABLE IF NOT EXISTS `wlp_object_relationshipmeta` (
  `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `object_relationship_id` bigint UNSIGNED NOT NULL DEFAULT '0',
  `meta_key` varchar(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `meta_value` longtext COLLATE utf8mb4_unicode_520_ci,
  PRIMARY KEY (`meta_id`),
...
--
-- Table structure for table `wlp_object_relationships`
--

CREATE TABLE IF NOT EXISTS `wlp_object_relationships` (
  `relationship_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `left_object_id` bigint UNSIGNED NOT NULL DEFAULT '0',
  `left_object_type` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
  `right_object_type` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT '',
  `right_object_id` bigint UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `wlp_options`
--

CREATE TABLE IF NOT EXISTS `wlp_options` (
...
--
-- Dumping data for table `wlp_options`
--

INSERT INTO `wlp_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'siteurl', 'http://wlp1.local', 'yes'),
(2, 'home', 'http://wlp1.local', 'yes'),
...
(9, 'admin_email', 'admin@wlp.local', 'yes'),
...
(43, 'template', 'twentyseventeen', 'yes'),
(44, 'stylesheet', 'twentyseventeen', 'yes'),
...
(94, 'admin_email_lifespan', '1749567658', 'yes'),
...
(110, 'widget_archives', 'a:2:{i:2;a:3:{s:5:\"title\";s:0:\"\";s:5:\"count\";i:0;s:8:\"dropdown\";i:0;}s:12:\"_multiwidget\";i:1;}', 'yes'),
...
(113, 'cron', 'a:5:{i:1734019259;a:1:{s:34:\"wp_privacy_delete_old_export_files\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"hourly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:3600;}}}i:1734058859;a:3:{s:18:\"wp_https_detection\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:16:\"wp_version_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}s:17:\"wp_update_plugins\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1734058860;a:1:{s:16:\"wp_update_themes\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:10:\"twicedaily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:43200;}}}i:1734102059;a:2:{s:30:\"wp_site_health_scheduled_check\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:6:\"weekly\";s:4:\"args\";a:0:{}s:8:\"interval\";i:604800;}}s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}', 'yes'),
(114, 'widget_pages', 'a:1:{s:12:\"_multiwidget\";i:1;}', 'yes'),
(115, 'widget_calendar', 'a:1:{s:12:\"_multiwidget\";i:1;}', 'yes'),
...
--
-- Table structure for table `wlp_postmeta`
--

CREATE TABLE IF NOT EXISTS `wlp_postmeta` (
  `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `wlp_postmeta`
--

INSERT INTO `wlp_postmeta` (`meta_id`, `post_id`, `meta_key`, `meta_value`) VALUES
...
--
-- Table structure for table `wlp_posts`
--

CREATE TABLE IF NOT EXISTS `wlp_posts` (
...
--
-- Dumping data for table `wlp_posts`
--
...
--
-- Table structure for table `wlp_termmeta`
--

CREATE TABLE IF NOT EXISTS `wlp_termmeta` (
  `meta_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `wlp_terms`
--

CREATE TABLE IF NOT EXISTS `wlp_terms` (
...
--
-- Dumping data for table `wlp_terms`
--

INSERT INTO `wlp_terms` (`term_id`, `name`, `slug`, `term_group`) VALUES
(1, 'Uncategorized', 'uncategorized', 0);

-- --------------------------------------------------------

--
-- Table structure for table `wlp_term_relationships`
--

CREATE TABLE IF NOT EXISTS `wlp_term_relationships` (
...
--
-- Dumping data for table `wlp_term_relationships`
--

INSERT INTO `wlp_term_relationships` (`object_id`, `term_taxonomy_id`, `term_order`) VALUES
(1, 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `wlp_term_taxonomy`
--

CREATE TABLE IF NOT EXISTS `wlp_term_taxonomy` (
...
--
-- Dumping data for table `wlp_term_taxonomy`
--

INSERT INTO `wlp_term_taxonomy` (`term_taxonomy_id`, `term_id`, `taxonomy`, `description`, `parent`, `count`) VALUES
(1, 1, 'category', '', 0, 1);

-- --------------------------------------------------------

--
-- Table structure for table `wlp_usermeta`, USER is replaced using install script
--

CREATE TABLE IF NOT EXISTS `wlp_usermeta` (
...
--
-- Dumping data for table `wlp_usermeta`
--
...
(11, 1, 'locale', ''),
(12, 1, 'wlp_capabilities', 'a:1:{s:13:\"administrator\";b:1;}'),
(13, 1, 'wlp_user_level', '10'),
...
--
-- Table structure for table `wlp_users`
--

CREATE TABLE IF NOT EXISTS `wlp_users` (
  `ID` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `wlp_users`, USER/PASS is replaced using install script
--
