...
if ( $admin_title === $title ) {
	...
	$admin_title = sprintf( __( '%s &#8212; WLP' ), $title );
} else {
	$screen_title = $title;
	...
	$admin_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; WLP' ), $screen_title, $admin_title );
}
...
var ajaxurl = '<?php echo esc_js( site_url('/wp-admin/admin-ajax.php') ); ?>',
