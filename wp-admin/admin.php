...
// <-- WLP test
/*
var_dump(PHP_EOL.'<br><br>------------<br><br>'.PHP_EOL);
$tokenv1info = _wlp_get_jwt_type();
$tokenv1 = wlp_jwt_verify(wlp_get_jwt(), WLP_JWT_SECRET);
var_dump($tokenv1);
var_dump($tokenv1info);
