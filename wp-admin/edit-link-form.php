...
get_current_screen()->add_help_tab(
	array(
		...
		'<p>' . __( 'XFN stands for <a href="https://gmpg.org/xfn/">XHTML Friends Network</a>, which is optional. WLP allows the generation of XFN attributes to show how you are related to the authors/owners of the site to which you are linking.' ) . '</p>',
	)
);
...
<div class="inside">
	...
	<p><?php _e( 'Example: <code>https://www.classicpress.net</code> &#8212; do not forget the <code>https://</code>' ); ?></p>
</div>
</div>
