<?php
/**
 * WLP Export Administration Screen
 *
 * @package WLP
...
get_current_screen()->add_help_tab(
	array(
		...
		'content' => '<p>' . __( 'You can export a file of your site&#8217;s content in order to import it into another installation or platform. The export file will be an XML file format called WXR. Posts, pages, comments, custom fields, categories, and tags can be included. You can choose for the WXR file to include only certain posts or pages by setting the dropdown filters to limit the export by category, author, date range by month, or publishing status.' ) . '</p>' .
			'<p>' . __( 'Once generated, your WXR file can be imported by another WLP site or by another blogging platform able to access this format.' ) . '</p>',
	)
);
...
<p><?php _e( 'When you click the button below WLP will create an XML file for you to save to your computer.' ); ?></p>
<p><?php _e( 'This format, which is called WLP eXtended RSS or WXR, will contain your posts, pages, comments, custom fields, categories, and tags.' ); ?></p>
<p><?php _e( 'Once you&#8217;ve saved the download file, you can use the Import function in another WLP installation to import the content from this site.' ); ?></p>
