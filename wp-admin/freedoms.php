...
<p class="about-text">
	...
	printf(
		...
		__( 'Thank you for using WLP, the <a href="%s">CMS for Creators</a>.' ),
...
<div class="about-wrap-content">
	<p class="about-description"><?php _e( 'From time to time, your WLP site may send anonymous data to WLP.net. Some examples of the kinds of data that may be sent are the version of WLP your site is running and a list of installed plugins and themes.' ); ?></p>

	<p><?php printf( __( 'We take privacy and transparency very seriously. To learn more about what data we collect, how we use it, and what precautions we take to ensure site owners&#8217; privacy, please see the <a href="%s">WLP Privacy Policy</a>.' ), 'https://link.classicpress.net/core-privacy-policy/' ); ?></p>
</div>

<?php else : ?>
<div class="about-wrap-content">
	<p class="about-description"><?php printf( __( 'WLP is Free and open source software, built by a distributed community of volunteer developers from around the world. WLP comes with some awesome, worldview-changing rights courtesy of its <a href="%s">license</a>, the GPL.' ), 'https://opensource.org/licenses/gpl-license' ); ?></p>
	...
	printf( __( 'Every plugin and theme in WLP.net&#8217;s directory is 100%% GPL or a similarly free and compatible license, so you can feel safe finding <a href="%1$s">plugins</a> and <a href="%2$s">themes</a> there. If you get a plugin or theme from another source, make sure to ask them if it&#8217;s <a href="%3$s">GPL</a> first. If they don&#8217;t respect the WLP license, we don&#8217;t recommend them.' ), $plugins_url, $themes_url, $license_url );
	?>
	</p>
