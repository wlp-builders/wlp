...
/**
 * Plugin Installer Skin for WLP Plugin Installer.
 *
 * @since 2.8.0
...
class Plugin_Installer_Skin extends WP_Upgrader_Skin {
	...
	public function after() {
		 ...
		 * @param object   $api             Object containing WLP.net API plugin data. Empty
	...
	private function do_overwrite() {
		...
		if ( ! is_wp_version_compatible( $requires_wp ) ) {
			$error = sprintf(
				...
				__( 'Your WLP version is %1$s, however the uploaded plugin requires %2$s.' ),
