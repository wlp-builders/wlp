			...
			<div class="menu-item-bar">
				<details class="menu-item-handle">
					<summary>
						...
						<label class="item-title" for="menu-item-checkbox-<?php echo $item_id; ?>"><span class="menu-item-title"><?php echo esc_html( $title ); ?></span></label>
						...
						<span class="item-controls">
							...
							<?php
							printf(
								'<span class="item-move" id="move-%s" aria-label="%s"><span class="screen-reader-text">%s</span><span class="dashicons dashicons-move" tabindex="0"></span></span>',
								$item_id,
