...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from WLP database
	 *
	...
	/**
	 * Return count of imported permalinks from WLP database
	 *
	 * @global wpdb $wpdb WordPress database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from WLP database
	 *
	 * @global wpdb $wpdb WordPress database abstraction object.
	 *
	 * @param string $blog_id
