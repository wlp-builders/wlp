...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir']    = __( 'Unable to locate WLP root directory.' );
		$this->strings['fs_no_content_dir'] = __( 'Unable to locate WLP content directory (wp-content).' );
		$this->strings['fs_no_plugins_dir'] = __( 'Unable to locate WLP plugin directory.' );
		$this->strings['fs_no_themes_dir']  = __( 'Unable to locate WLP theme directory.' );
