<?php
/**
 * Deprecated admin functions from past WLP or WordPress versions. You shouldn't use these
...
/**
 * Display plugins text for the WLP news widget.
 *
 * @since 2.5.0
 * @deprecated 4.8.0
 *
	...
	foreach ( $deprecated_scripts as $deprecated_script ) {
		if ( wp_script_is( $deprecated_script, 'enqueued' ) ) {
			$message = sprintf(
				...
				__( 'The enqueued script %1$s has been deprecated. It will be removed in version 3.0.0 of WLP. Further details may be found at %2$s.' ),
				$deprecated_script,
	...
	foreach ( $deprecated_styles as $deprecated_style ) {
		if ( wp_style_is( $deprecated_style, 'enqueued' ) ) {
			$message = sprintf(
				...
				__( 'The enqueued stylesheet %1$s has been deprecated. It will be removed in version 3.0.0 of WLP. Further details may be found at %2$s.' ),
				$deprecated_style,
				'https://www.classicpress.net/deprecated-scripts/'
			);
