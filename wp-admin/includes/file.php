...
/**
 * Gets the description for standard WLP theme files.
 *
 * @since 1.5.0
 *
...
/**
 * Gets the absolute filesystem path to the root of the WLP installation.
 *
 * @since 1.5.0
 *
 * @return string Full filesystem path to the root of the WLP installation
 */
...
function _wp_handle_upload( &$file, $overrides, $time, $action ) {
	...
	/**
	 * Filters the data for a file before it is uploaded to WLP.
	 *
...
/**
 * Downloads a URL to a local temporary file using the WLP HTTP API.
 *
...
/**
 * Initializes and connects the WLP Filesystem Abstraction classes.
 *
	...
	if ( ! $method ) {
		...
		if ( $temp_handle ) {
			...
			if ( false !== $wp_file_owner && $wp_file_owner === $temp_file_owner ) {
				/*
				 * WLP is creating files as the same owner as the WordPress files,
...
<p id="request-filesystem-credentials-desc">
	...
	_e( 'To perform the requested action, WLP needs to access your web server.' );
	echo ' ';
