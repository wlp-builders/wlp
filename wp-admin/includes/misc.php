 ...
 */
 ...
 /**
  * Prints information about the WLP development version, if any.
  *
  * @since CP-1.0.0
  */
 ...
 *
 * @since 1.5.0
 * @since CP-1.0.0 Added $is_regex parameter.
 *
 ...
 *
 * @since 1.5.0
 * @since CP-1.0.0 Added $marker_out and $is_regex parameters.
 *
 ...
 * @since 1.5.0
 *
 * @global WP_Rewrite $wp_rewrite WLP rewrite component.
 *
...
/**
 * Checks if rewrite rule for WLP already exists in the IIS 7+ configuration file
 *
 * @since 2.8.0
 *
...
/**
 * Deletes WLP rewrite rule from web.config file if it exists there
 *
 * @since 2.8.0
 *
...
/**
 * Adds WLP rewrite rule to the IIS 7+ configuration file.
 *
 * @since 2.8.0
 *
 * @param string $filename     The file path to the configuration file.
...
function wp_admin_canonical_url() {
	if ( is_admin() ) {
		// Code for admin area, prevent unnecessary redirects
		return false;
	}
...
function wp_check_php_version() {
	...
	if ( false === $response ) {
		 ...
		 *  'recommended_version' - string - The PHP version recommended by WLP.
	...
	if ( isset( $response['is_acceptable'] ) && $response['is_acceptable'] ) {
		/**
		 * Filters whether the active PHP version is considered acceptable by WLP.
		 *
