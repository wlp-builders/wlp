...
//  <!-- WLP immediately try to activate decentralize plugin default plugin -->
if(!is_plugin_active('decentralized-plugins/decentralized-plugins.php')) {
    //activate_plugin('decentralized-plugins/decentralized-plugins.php');
}
...
$help  = '<p>' . __( 'Welcome to your WLP Dashboard!' ) . '</p>';
$help .= '<p>' . __( 'The Dashboard is the first place you will come to every time you log into your site. It is where you access to all the site management features of WLP. You can get help for any screen by clicking the Help tab above the screen title.' ) . '</p>';
...
$help  = '<p>' . __( 'The left-hand navigation menu provides links to all of the WLP administration screens, with submenu items displayed on hover. You can minimize this menu to a narrow icon strip by clicking on the Collapse Menu arrow at the bottom.' ) . '</p>';
$help .= '<p>' . __( 'Links in the Toolbar at the top of the screen connect your dashboard and the front end of your site, and provide access to your profile and helpful WLP information.' ) . '</p>';
...
if ( current_user_can( 'edit_posts' ) ) {
	$help .= '<p>' . __( '<strong>At a Glance</strong> &mdash; Displays a summary of the content on your site and identifies which theme and version of WLP you are using.' ) . '</p>';
}
...
$help .= '<p>' . sprintf(
	/* translators: %s: WLP Planet URL. */
	__( '<strong>WLP News</strong> &mdash; Latest news from the official <a href="%s">WLP blog</a>.' ),
