...
function setup_plugins_menu() {
    global $menu;

    // Modify the existing Plugins menu item at index 65
    $count = ''; // You can calculate or define the count of plugins here if needed
    $menu[65] = array(
        sprintf(__('Plugins %s'), $count), // Modify the main menu item title if needed
        'activate_plugins', // Capability required to access this menu
        'plugins.php', // The slug for the plugins page
        '', // No additional page title
        'menu-top menu-icon-plugins', // CSS classes
        'menu-plugins', // Unique identifier for the menu
        'dashicons-admin-plugins' // Icon for the menu item
    );

    // Immediately handle the redirect if accessing the plugin-manager page
...
// Execute the function to set up the menu
setup_plugins_menu();
