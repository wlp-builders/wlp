...
get_current_screen()->add_help_tab(
	array(
		...
		'title'   => __( 'Overview' ),
		'content' =>
			'<p>' . __( 'Only use this screen once you have updated to a new version of WLP through Updates/Available Updates (via the Network Administration navigation menu or the Toolbar). Clicking the Upgrade Network button will step through each site in the network, five at a time, and make sure any database updates are applied.' ) . '</p>' .
...
switch ( $action ) {
	...
	default:
		...
		<p><?php _e( 'WLP has been updated! Next and final step is to individually upgrade the sites in your network.' ); ?></p>
		<?php endif; ?>
