...
if ( ! is_multisite() ) {
	$options_help .= '<p>' . __( 'The WLP URL and the site URL can be the same (example.com) or different; for example, having the WLP core files (example.com/classicpress) in a subdirectory instead of the root directory.' ) . '</p>' .
...
$sample_tagline = __( 'Just another WLP site' );
if ( is_multisite() ) {
...
<tr>
<th scope="row"><label for="siteurl"><?php _e( 'WLP Address (URL)' ); ?></label></th>
...
<p class="description" id="home-description">
		...
		printf(
			...
			__( 'Enter the same address here unless you <a href="%s">want your site home page to be different from your WLP installation directory</a>.' ),
...
<td>
	<fieldset>
		...
		<p class="description" id="login_custom_image-description">
			<?php _e( 'If you choose an image here and enable this option, then that image will be shown at the top of the login page instead of the WLP logo.' ); ?>
		...
		<label>
			...
			<?php _e( 'No custom image: use the <strong>WLP logo</strong>' ); ?>
		</label>
		<br>
		<label>
...
<p class="description" id="home-description">
<?php _e( 'WLP is incompatible with the block editor. When blocks compatibility is turned on (default), it allows more plugins and themes to work but block-related features will not work. ' ); ?>
