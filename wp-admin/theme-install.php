...
$help_overview =
	'<p>' . sprintf(
		...
		__( 'You can find additional themes for your site by using the Theme Browser/Installer on this screen, which will display themes from the <a href="%s">WLP Theme Directory</a>. These themes are designed and developed by third parties, are available free of charge, and are compatible with the license WordPress uses.' ),
	...
	<# if ( ! data.compatible_wp || ! data.compatible_php || ! data.compatible_cp ) { #>
		<div class="notice notice-error notice-alt"><p>
			...
			<# } else if ( ! data.compatible_cp ) { #>
				<?php
				_e( "FSE themes don't work with WLP." );
				?>
