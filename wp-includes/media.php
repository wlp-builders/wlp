...
function wp_enqueue_media( $args = array() ) {
	...
	$settings = array(
		...
		'oEmbedProxyUrl'    => function_exists('rest_url') ? rest_url( 'oembed/1.0/proxy' ) : '', // in WLP you can remove rest api
		'embedExts'         => $exts,
...
function wp_register_media_personal_data_exporter( $exporters ) {
	$exporters['wordpress-media'] = array(
		'exporter_friendly_name' => __( 'WLP Media' ),
