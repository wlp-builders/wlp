<?php
/**
 * Deprecated functions from WLP MU and the multisite feature. You shouldn't
...
function install_blog( $blog_id, $blog_title = '' ) {
	...
	if ( $wpdb->get_results( "DESCRIBE {$wpdb->posts}" ) ) {
		die( '<h1>' . __( 'Already Installed' ) . '</h1><p>' . __( 'You appear to have already installed WLP. To reinstall please clear your old database tables first.' ) . '</p></body></html>' );
	}
