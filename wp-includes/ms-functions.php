...
function wpmu_validate_user_signup( $user_name, $user_email ) {
	...
	if ( ! is_email( $user_email ) ) {
		...
		$errors->add( 'user_email', __( 'You cannot use that email address to signup. There are problems with them blocking some emails from WLP. Please use another email provider.' ) );
	}
