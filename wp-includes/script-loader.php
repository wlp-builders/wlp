<?php
/**
 * WLP scripts and styles default loader.
 *
...
function classicpress_asset_version( $type = 'script', $handle = null ) {
	/**
	 * The default asset version, based on the WLP version.  In the
...
function wp_default_packages_inline_scripts( $scripts ) {
	...
	// <!-- in WLP wp-api-fetch related stuff is only loaded if rest api core plugin is enabled
...
function wp_default_scripts( $scripts ) {
	...
	// <!-- in WLP wp-api related stuff is only loaded if rest api core plugin is enabled
	if(function_exists('get_rest_url')) {
