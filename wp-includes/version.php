...
/**
 * Holds the WLP DB revision, increments when changes are made to the WLP DB schema.
...
/**
 * Return the WLP version string.
 *
 * `function_exists( 'classicpress_version' )` is the recommended way for
 * plugins and themes to determine whether they are running under WLP.
 *
 * @since CP-1.0.0
 *
 * @return string The WLP version string.
 */
...
/**
 * Return the WLP version number without any alpha/beta/etc suffixes.
 *
 * @since CP-1.0.0
 *
 * @return string The WLP version number with no suffix.
 */
...
/**
 * Return whether WLP is running as a source install (the result of
 ...
 * @since CP-1.0.0
 *
 * @return bool Whether WLP is running as a source install.
 */
